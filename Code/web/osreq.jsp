...
<body id="top">
  ...
  <nav id="mainav" class="hoc clear"> 
    <ul class="clear" style="float: center">
      ...
      <li ><a style="text-decoration: none;" href="usginin.jsp">Data User</a></li>
    ...
    <div>
        <center> <br> <br><br><br>
            <h1 style="color:whitesmoke">Cloud Service eligibility</h1> <br> <div class="wrap-login100" >
             <form id="verify" action="csverify.jsp" method="post">
                                        <div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="name">
						<span class="focus-input100" data-placeholder="Acesskey"></span>
					</div>
