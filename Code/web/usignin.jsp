...
<body id="top">
  ...
  <nav id="mainav" class="hoc clear"> 
    ...
    <ul class="clear" style="float: center">
      ...
      <li  class="active"><a style="text-decoration: none;" href="usignin.jsp">Data User</a></li>
      ...
      <li><a href="cloudverify.jsp">Cloud</a></li>
       ...
       <div style="background-image: url(images/d1.jpg); background-repeat:no-repeat; background-position:center; background-size:cover;">
    <div>
        <center> <br> <br><br><br>
            <h1 style="color:white"> User Signup</h1> <br> <div class="wrap-login100" >
             <form id="service" action="uverify.jsp" method="post">
                ...
                <a href="UserSignup.jsp"> Click here for new registration</a>
