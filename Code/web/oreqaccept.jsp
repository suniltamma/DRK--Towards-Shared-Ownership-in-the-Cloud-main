  ...
  <nav id="mainav" class="hoc clear">   
    ...
    <div class="limiter">
		<div class="container-table100">
			...
			String rstatus="no",rowner=(String)session.getAttribute("name"),raowner=null;
...
try
{
	 con = DbConnection.getConnection();
        String qry="select rid,raowner,requestedspace from reqspace where rowner='"+rowner+"' and requestedStatus='"+rstatus+"'";
						...
						<tbody>
								<tr>
									...
									<td class="column2"><%=requestedspace%></td>
                                                                        ...
                                                                        <td class="column5"><a href="oreqaccept1.jsp?rid=<%=rid%>&&raowner=<%=raowner%>&&rspace=<%=requestedspace%>&&rowner=<%=rowner%>">Accept</a></td>
