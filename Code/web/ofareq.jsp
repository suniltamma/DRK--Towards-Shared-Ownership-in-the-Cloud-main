...
try
{
	 con = DbConnection.getConnection();
        String qry="select sid,fid,id,reqowner,fname,skey from oreq where name='"+reqowner+"'";
...
<td class="column2">
    <% if(skey.equalsIgnoreCase("Not Genrated")){
        %><a href="generateSharedKey.jsp?sid=<%=sid%>">Generate Key</a> <%
    }else{
        out.println(skey);
    } %>
    </td>
 <td class="column5"><a href="#" onclick="window.open('UpdateFileStatus.jsp?sid=<%=sid%>', 'newwindow', 'width=400,height=350'); return false;">File Access Rights </a></td>
</tr>
<%	  
}
}
 catch(Exception e1)
{
 ...
 %>	
   ...
   <div id="id01" class="modal">
    ...
    <form id="#secnd"class="modal-content animate" action="ofareq1.jsp" method="post">
    ...
    <div class="container">
        <label for="uname"><b>Request Id</b></label>
        <input type="text"  name="sid" value=<%=request.getParameter("sid")%>
      
      <label for="uname"><b>Read</b></label>
      <input type="checkbox" name="read" value="yes" uncheked>

        <label for="uname"><b>Write</b></label>
      <input type="checkbox"  name="write" value="yes" uncheked>
      
       <label for="uname"><b>Delete</b></label>
      <input type="checkbox"  name="Delete" value="yes" uncheked>
