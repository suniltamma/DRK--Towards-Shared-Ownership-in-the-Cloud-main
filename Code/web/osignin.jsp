...
<body id="top">
  ...
  <nav id="mainav" class="hoc clear"> 
    <ul class="clear" style="float: center">
      ...
      <li class="active"><a style="text-decoration: none;" href="osignin.jsp">Data Owner</a></li>
      ...
      <li><a href="cloudverify.jsp">Cloud</a></li>
       ...
       <div style="background-image: url(images/c1.jpg); background-repeat:no-repeat; background-position:center; background-size:cover;">
    <div>
        <center> <br> <br><br><br>
            <h1 style="color:black">Owner SignIn</h1> <br> <div class="wrap-login100" >
             <form id="verify" action="overify.jsp" method="post">
                ...
                <a style="text-decoration: none;" href="Ownesginup.jsp"> Click here for new registration</a>
